                                        ...
                                        <form onSubmit={handleLead}>
                                            ...
                                            <div className="mt-6">
                                                ...
                                                <textarea
                                                    required
                                                    name="mensaje"
                                                    className="w-full min-h-[140px] rounded-[1rem] border border-black/10 bg-white/70 px-5 py-3.5 text-[15px] font-medium text-ink focus:outline-none focus:ring-2 focus:ring-accent/40 focus:border-accent/30 transition-all resize-none placeholder:text-gray-400 placeholder:font-light leading-relaxed"
                            ...
                            <div>
                                ...
                                <div className="grid gap-6">
                                    ...
                                    <div className="flex flex-col gap-2">
                                        <div className="text-[11px] text-gray-400 font-bold uppercase tracking-widest">Alta Dirección</div>
                                    ...
                                    <div className="flex flex-col gap-3 pt-2">
                                        <div className="text-[11px] text-gray-400 font-bold uppercase tracking-widest">Ventas & Nuevos Proyectos</div>
                                        <div className="grid gap-3">
                                            ...
                                            <a
                                                ...
                                                className="inline-flex items-center justify-between w-full p-3.5 rounded-xl border border-black/5 bg-white/70 hover:bg-green-50/80 hover:border-green-500/30 transition-all duration-300 group"
                                            >
                                                <div className="flex items-center gap-3">
                                                    <svg className="w-4 h-4 fill-green-500 group-hover:scale-110 transition-transform duration-300" viewBox="0 0 24 24">
                                                    ...
                                                    <span className="text-[13px] font-bold text-ink tracking-tight italic">WhatsApp Directo</span>
                                                </div>
                                    ...
                                    <div className="flex flex-col gap-2 pt-2">
                                        <div className="text-[11px] text-gray-400 font-bold uppercase tracking-widest">Ingeniería & Licitaciones</div>
                                        ...
                                        <div className="grid gap-6">
                                            ...
                                            <div className="group/loc">
                                                ...
                                                <div className="flex flex-col gap-2">
                                                    <a href="tel:6688155975" className="text-[13px] text-gray-600 hover:text-accent flex items-center gap-2 transition-colors">
                                                        <span className="opacity-40 font-bold uppercase text-[9px]">Oficina.</span> <span className="font-bold">668 815 5975</span>
                                                    </a>
                                                    <a href="tel:6682228008" className="text-[13px] text-gray-600 hover:text-accent flex items-center gap-2 transition-colors">
                                                        <span className="opacity-40 font-bold uppercase text-[9px]">Directo.</span> <span className="font-bold">668 222 8008</span>
                                                    </a>
                                                </div>
                                            </div>
                                            ...
                                            <div className="group/loc">
                                                ...
                                                <a href="tel:6424273489" className="text-[13px] text-gray-600 hover:text-accent flex items-center gap-2 transition-colors">
                                                    <span className="opacity-40 font-bold uppercase text-[9px]">Central.</span> <span className="font-bold">642 427 3489</span>
                                                </a>
                                            </div>
                                        </div>
                                    </div>
