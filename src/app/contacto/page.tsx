                                            ...
                                            >
                                                <div className="flex items-center gap-3">
                                                    <div className="relative">
                                                        ...
                                                        <svg className="w-4 h-4 fill-green-500 relative z-10" viewBox="0 0 24 24">
                                                    ...
                                                    <span className="text-[13px] font-bold text-ink tracking-tight italic">🟢 Habla con un asesor ahora</span>
                                                </div>
