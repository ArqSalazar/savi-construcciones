                                ...
                                <div className="grid gap-5">
                                    <div className="flex flex-col gap-3 border-b border-black/5 pb-5">
                                        ...
                                        <a
                                            ...
                                            className="inline-flex items-center justify-between w-full p-4 rounded-xl border border-black/5 bg-white/70 hover:bg-green-50/80 hover:border-green-500/30 transition-all duration-300 group"
                                        >
                                            <div className="flex items-center gap-3">
                                                ...
                                                <span className="text-[14px] font-bold text-ink tracking-tight italic">Link Directo SAVI</span>
                                            </div>
                                    ...
                                    <div className="flex flex-col gap-3 border-b border-black/5 pb-5">
                                        <div className="text-[13px] text-gray-500 font-medium tracking-tight">Soporte al Inversionista</div>
                                    ...
                                    <div className="flex flex-col gap-5 border-b border-black/5 pb-6">
                                        <div className="text-[13px] text-gray-500 font-medium tracking-tight">Sedes de Operación</div>
                                    ...
                                    <div className="flex items-center justify-between gap-4 pt-2">
                                        <div className="text-[13px] text-gray-500 font-medium">Asistencia Ejecutiva</div>
                                        <div className="text-[14px] font-bold text-ink text-right">Lun–Vie · 09:00–18:00 hr</div>
                                    </div>
                                </div>
                            </div>
